...
public class DataTableUtil {
    ...
    public static String getBeanToJsonString(Object beanClass) {
        return ObjectMapperUtil.convertToString(beanClass);
    }
    ...
    public static String getParameter(HttpServletRequest request, String name, Object value) {
        return (request.getParameter(name) == null) ? String.valueOf(value) : request.getParameter(name);
    }
